...
export function TicketManagementForm({ data = [], updateData, eventId }: TicketManagementFormProps) {
  ...
  // Add this function to validate tickets without requiring ticket number and user ID
  const validateTickets = () => {
    ...
    // Check if any tickets have empty required fields (only name is required)
            ...
            <Card className="p-4 space-y-3 pt-6">
                    ...
                    onValueChange={(value) => {
                      if (value !== "Free") {
                        toast({
                          ...
                          description:
                            "Paid and Donation tickets require a premium subscription. Please upgrade to continue.",
                          variant: "warning",
                        })
                        // Force it to stay as "Free"
                        handleTicketChange(selectedTicket.id, "pricingModel", "Free")
                      } else {
                        handleTicketChange(selectedTicket.id, "pricingModel", value)
                      }
                    }}
                  >
                    <SelectTrigger>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Paid" className="text-muted-foreground">
                        Paid (Premium)
                      </SelectItem>
                      <SelectItem value="Donation" className="text-muted-foreground">
                        Donation (Premium)
                      </SelectItem>
                    </SelectContent>
                  </Select>
              ...
              <div className="pt-4">
                <TicketPreview
                  ...
                  onSelectDesign={() => {}} // Empty function since we're not allowing design changes
                />
              </div>
            </Card>
          )}
